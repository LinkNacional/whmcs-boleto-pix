    ...
    $config = [
        ...
        'nota' => [
            ...
            <table>
                <tbody>
                    <tr>
                        <td>Versão <h2 style='font-weight: bold; margin-top: 0px; font-size: 300%;'>2.5.0</h2></td>
                    </tr>
                </tbody>
            </table>
...
Sempre começa por apk_. Caso não tenha essa informação, pegue sua chave API <a href='https://www.paghiper.com/painel/credenciais/' target='_blank'><strong>aqui</strong></a>.",
        ...
        'maximum_payment_amount' => [
            'FriendlyName' => 'Valor máximo para pagamento',
            'Type' => 'text',
            'Size' => '3',
            'Description' => 'Ex: 50,00 e 5000,00 - utilizar apenas números e vírgulas.',
        ],
        'minimum_payment_amount' => [
            'FriendlyName' => 'Valor mínimo para pagamento',
            'Type' => 'text',
            'Size' => '3',
            'Description' => 'Ex: 5,00 e 50,00 - utilizar apenas números e vírgulas.',
        ],
        'min_amount_for_taxes_exempt' => [
            'FriendlyName' => 'Isentar de taxas',
            'Type' => 'text',
            'Size' => '3',
            'Description' => 'Não aplicar taxas (Taxa percentual + Taxa fixa) quando o valor da fatura for maior ou igual a este. Ex: 100,00 (usar apenas vírgulas).',
        ],
        'admin' => [
...
{
    $isElegibleForPayment = paghiper_is_balance_elegible_for_payment('paghiper_pix', $params['invoiceid']);

    if (is_string($isElegibleForPayment)) {
        return $isElegibleForPayment;
    }
